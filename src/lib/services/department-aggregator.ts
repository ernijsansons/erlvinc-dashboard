 ...
 *
 * Aggregates planning artifacts from 18 phases into 15 department-specific views.
...
import { getDepartmentTitle, getDepartmentDescription } from '$lib/types/bible';
 ...
 */
export function artifactsToMap(artifacts: PlanningArtifact[]): Record<PhaseName, PlanningArtifact> {
